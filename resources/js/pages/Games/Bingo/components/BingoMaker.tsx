    ...
    const handleBingoSubmit = async () => {
        await toast.promise(
            ...
            }).unwrap(),
            {
                ...
                error: (err) => err?.data?.message || "Failed to start bingo game",
            }
        );
    };
            ...
            <section className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                    ...
                    <div className="flex-1 flex justify-center md:justify-end w-full">
                        ...
                        >
                            {Array.from({ length: bingoSize * bingoSize }).map((_, i) => (
                                <div
                                    key={i}
                                    className={`rounded-sm flex items-center justify-center ${i === Math.floor((bingoSize * bingoSize) / 2)
                                        ? "bg-primary/20 border border-primary/30"
                                        : "bg-surface-container-high"
                                        }`}
                                >
                                    {i === Math.floor((bingoSize * bingoSize) / 2) && (
            ...
            <div className="mt-4 pt-6 border-t border-outline-variant flex justify-center md:justify-end">
                ...
                >
                    <span className="text-lg">
                        {isLoading ? "CREATING..." : "START BINGO"}
                    </span>
