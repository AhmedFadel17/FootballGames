...
class CareerGameInstanceResource extends JsonResource
{
    public function toArray($request): array
    {
        $allPeriods = $this->careerGame->player->teamPeriods()
        ...
        return [
            ...
            'total_steps' => $this->careerGame->total_steps,
            'revealed_steps' => $this->revealed_steps,
            'attempts_left' => $this->attempts_left,
            'difficulty' => $this->careerGame->difficulty,
            'steps' => $steps,
        ];
    }
}