...
class StorePackDropRuleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'drop_type' => ['required', Rule::in(['player_card', 'team', 'powerup', 'cosmetic', 'coins'])],
            ...
            'drop_percentage' => ['required', 'numeric', 'min:0.01', 'max:100'],
        ];
    }
}